  ...
  return (
    <div id="___gatsby">
      <div style={{ outline: "none" }} tabIndex={-1} id="gatsby-focus-wrapper">
        <header className="LogoLinksButton--header--TPR5X">
          <div className="row">
        ...
        <main>
          <div data-isloading="false">
            <section className="index--hero--yyRcH">
            ...
            <section className="index--benefitList--YOhNN">
              <div className="container">
                <h2>We negotiate better rates than if you shop directly</h2>
                <div className="row" />
              </div>
            </section>
            <section className="index--darkSection--j5WFl">
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <img
                      src="images/index/lady-image.jpg"
                      alt="Lady Image"
                      loading="lazy"
                    />
                  </div>
                  <div className="col-12 col-md-10 col-xl-8 offset-md-1 offset-xl-2">
                    <div className="row">
                      <div className="col-12 col-lg-6">
                        <h2>What determines your auto insurance rate?</h2>
                      </div>
                      <div className="col-12 col-lg-6">
                        <p>
                          Shopping for car insurance is challenging because
                          there is no best provider concept. Each provider
                          offers a better experience and deal for a different
                          kind of driver. This is why two people can apply to
                          the same provider and get completely different price
                          ranges. Your insurance rates depend on many factors,
            ...
            <section className="index--twoColumns--b0PD3">
              <div className="container">
                <div className="row">
                  <div className="col-12 col-md-6 col-xl-5">
                    <img
                      src="images/index/car-image.jpg"
                      alt="Car Image"
                      loading="lazy"
                    />
                    <h3>
                      <small>vehicle</small>Your vehicle is the biggest factor
                      in your insurance
                    </h3>
                    <p>
                      Some insurance providers are better for certain types of
                      vehicles. If you have a large truck or a luxury vehicle it
                      would be more expensive to replace therefore more
                      expensive to insure. Also, your location plays a big role,
                      some providers, such as Tennessee Farmers are better for a
                      2017 Audi R8, while a 2015 model would be better with
                      Progressive.
                    </p>
                  </div>
                  <div className="col-12 col-md-6 col-xl-5 offset-xl-2">
                    <img
                      src="images/index/car-image-2.jpg"
                      alt="Car Image"
                      loading="lazy"
                    />
                    <h3>
                      <small>location</small>Location is the second biggest
                      factor in the equation
                    </h3>
                    <p>
                      Geographic concerns play a large factor in how insurance
                      providers determine their rates. For example, in states
                      where hail and flooding are common you’ll see a major
                      increase in automobile insurance rates. Also, cities with
                      crowded populations, such as Los Angeles, result in common
                      accidents leading to 20% higher rates than the national
                      average. Each insurance provider evaluates these risks
                      differently and you’ll see rates that will commonly vary
                      by more than 200%.
                    </p>
                  </div>
                </div>
            ...
            <section className="cta--cta--PGdMw">
              <div className="container">
